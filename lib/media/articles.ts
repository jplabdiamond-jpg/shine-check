...
<div class="article-img-box">
  <img src="/blog/blog_slip-management.webp" alt="開票画面：卓選択 → 伝票オープン → 入力フォーム" loading="lazy" />
...
<div class="article-img-box">
  <img src="/blog/blog_slip-management.webp" alt="商品追加画面：カテゴリ絞り込み → 数量入力 → 伝票反映" loading="lazy" />
...
<div class="article-img-box">
  <img src="/blog/blog_slip-management.webp" alt="精算画面：支払い方法選択 → 金額入力 → 確定ボタン" loading="lazy" />
...
<div class="article-img-box">
  <img src="/blog/blog_table-management.webp" alt="卓管理一覧：ステータスカラーと経過時間表示" loading="lazy" />
  <p class="article-img-caption">卓管理一覧：ステータスカラーと経過時間表示</p>
</div>
...
<div class="article-img-box">
  <img src="/blog/blog_table-management.webp" alt="担当キャスト変更画面：複数選択・時間帯ログ" loading="lazy" />
  <p class="article-img-caption">担当キャスト変更画面：複数選択・時間帯ログ</p>
</div>
...
<div class="article-img-box">
  <img src="/blog/blog_product-management.webp" alt="商品登録画面：名称・カテゴリ・単価・税区分入力" loading="lazy" />
...
<div class="article-img-box">
  <img src="/blog/blog_product-management.webp" alt="一括編集モード：チェックボックス選択 → 価格変更ダイアログ" loading="lazy" />
...
<div class="article-img-box">
  <img src="/blog/blog_customer-management.webp" alt="顧客登録画面：基本情報・メモ・担当キャスト選択" loading="lazy" />
  <p class="article-img-caption">顧客登録画面：基本情報・メモ・担当キャスト選択</p>
</div>
...
<div class="article-img-box">
  <img src="/blog/blog_customer-management.webp" alt="顧客詳細：ランクバッジ・来店回数・累計金額表示" loading="lazy" />
  <p class="article-img-caption">顧客詳細：ランクバッジ・来店回数・累計金額表示</p>
</div>
...
<div class="article-img-box">
  <img src="/blog/blog_settings-guide.webp" alt="料金設定画面：税率・サービス料・計算方式スイッチ" loading="lazy" />
...
<div class="article-img-box">
  <img src="/blog/blog_settings-guide.webp" alt="セットメニュー一覧：コース名・時間・人数単価の一覧管理" loading="lazy" />
  <p class="article-img-caption">セットメニュー一覧：コース名・時間・人数単価の一覧管理</p>
</div>
...
<div class="article-img-box">
  <img src="/blog/blog_stripe-plan-upgrade.webp" alt="プラン選択画面：Standard/Premium比較・Stripeチェックアウト" loading="lazy" />
  <p class="article-img-caption">プラン選択画面：Standard/Premium比較・Stripeチェックアウト</p>
</div>
...
<div class="article-img-box">
  <img src="/blog/blog_trouble-login.webp" alt="ログイン画面：メール入力・パスワード入力・「パスワードを忘れた」リンク" loading="lazy" />
  <p class="article-img-caption">ログイン画面：メール入力・パスワード入力・「パスワードを忘れた」リンク</p>
</div>
...
<div class="article-img-box">
  <img src="/blog/blog_trouble-login.webp" alt="管理者画面：スタッフ招待 → メール送信 → 招待再送" loading="lazy" />
  <p class="article-img-caption">管理者画面：スタッフ招待 → メール送信 → 招待再送</p>
</div>
...
<div class="article-img-box">
  <img src="/blog/blog_trouble-slip-error.webp" alt="伝票詳細：料金内訳展開表示（セット・延長・商品・サービス料・税）" loading="lazy" />
...
<div class="article-img-box">
  <img src="/blog/blog_trouble-slip-error.webp" alt="伝票履歴：精算済み一覧 → 再オープンボタン" loading="lazy" />
  <p class="article-img-caption">伝票履歴：精算済み一覧 → 再オープンボタン</p>
</div>
...
<div class="article-img-box">
  <img src="/blog/blog_usecase-snack.webp" alt="カウンター席メインのシンプルな卓構成例" loading="lazy" />
  <p class="article-img-caption">カウンター席メインのシンプルな卓構成例</p>
</div>
...
<div class="article-img-box">
  <img src="/blog/blog_usecase-hostclub.webp" alt="キャスト管理：ホスト一覧・指名料金・バック率設定" loading="lazy" />
  <p class="article-img-caption">キャスト管理：ホスト一覧・指名料金・バック率設定</p>
</div>
...
<div class="article-img-box">
  <img src="/blog/blog_usecase-hostclub.webp" alt="キャスト別売上：担当売上・指名本数・バック金額一覧" loading="lazy" />
...
<div class="article-img-box">
  <img src="/blog/blog_csv-export.webp" alt="分析 → CSV出力：期間選択・データ種別選択・ダウンロードボタン" loading="lazy" />
  <p class="article-img-caption">分析 → CSV出力：期間選択・データ種別選択・ダウンロードボタン</p>
</div>
...
<div class="article-img-box">
  <img src="/blog/blog_csv-export.webp" alt="Excel展開例：日次売上CSVをグラフ化したサンプル" loading="lazy" />
  <p class="article-img-caption">Excel展開例：日次売上CSVをグラフ化したサンプル</p>
</div>
...
<div class="article-img-box">
  <img src="/blog/blog_staff-permission.webp" alt="スタッフ管理画面：権限別一覧・招待ボタン" loading="lazy" />
  <p class="article-img-caption">スタッフ管理画面：権限別一覧・招待ボタン</p>
</div>
...
<div class="article-img-box">
  <img src="/blog/blog_usecase-multi-store.webp" alt="店舗切り替え：ヘッダーの店舗名ドロップダウン → 即時切り替え" loading="lazy" />
  <p class="article-img-caption">店舗切り替え：ヘッダーの店舗名ドロップダウン → 即時切り替え</p>
</div>
...
<div class="article-img-box">
  <img src="/blog/blog_usecase-multi-store.webp" alt="グループサマリー：複数店舗の月次売上比較グラフ" loading="lazy" />
  <p class="article-img-caption">グループサマリー：複数店舗の月次売上比較グラフ</p>
</div>
...
<div class="article-img-box">
  <img src="/blog/blog_getting-started-checklist.webp" alt="設定画面チェック：税率・サービス料・セット時間が正しく入力されている状態" loading="lazy" />
...
<div class="article-img-box">
  <img src="/blog/blog_getting-started-checklist.webp" alt="スタッフ一覧：全員がアクティブ（緑）になっている確認画面" loading="lazy" />
  <p class="article-img-caption">スタッフ一覧：全員がアクティブ（緑）になっている確認画面</p>
</div>
