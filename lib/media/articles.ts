...
<div class="article-img-box">
  <img src="/blog/sc_product_select.webp" alt="精算画面：支払い方法選択 → 金額入力 → 確定ボタン" loading="lazy" />
...
<div class="article-img-box">
  <img src="/blog/sc_slip_checkout.webp" alt="伝票詳細：料金内訳展開表示（セット・延長・商品・サービス料・税）" loading="lazy" />
