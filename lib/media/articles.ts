...
<div class="screenshot-box">
  📸 <em>商品追加画面：カテゴリ絞り込み → 数量入力 → 伝票反映</em>
</div>
...
<div class="screenshot-box">
  📸 <em>一括編集モード：チェックボックス選択 → 価格変更ダイアログ</em>
</div>
...
<div class="screenshot-box">
  📸 <em>料金設定画面：税率・サービス料・計算方式スイッチ</em>
</div>
...
<div class="screenshot-box">
  📸 <em>伝票詳細：料金内訳展開表示（セット・延長・商品・サービス料・税）</em>
</div>
...
<div class="screenshot-box">
  📸 <em>キャスト別売上：担当売上・指名本数・バック金額一覧</em>
</div>
...
<div class="screenshot-box">
  📸 <em>設定画面チェック：税率・サービス料・セット時間が正しく入力されている状態</em>
</div>
